<template>
  <div class="app">
    ...
    <div id="listContainer">
      <ProductList :productList="productData" :isLoading="isLoading"></ProductList>
    </div>
  </div>
</template>
...
export default defineComponent({
  ...
  setup() {
    ...
    return { btnText, textPlaceholderSearch, typeInputSearch, productData, originalData, isLoading }
  },
  data() {
    return {
      search: "" 
